      ...
      <AnimatePresence>
        {cartItemCount > 0 && (
          <motion.div
            ...
            className="fixed bottom-4 left-4 right-4 md:left-1/2 md:right-auto md:-translate-x-1/2 md:w-full md:max-w-xs bg-[#D36B53] text-white rounded-xl shadow-lg px-3.5 py-2 flex items-center justify-between z-[90] border border-white/10"
          >
            <div className="flex flex-col text-left min-w-0">
              <span className="text-[10px] opacity-90 font-medium tracking-wide truncate">
            ...
            <button
              ...
              className="bg-white text-[#D36B53] font-bold text-xs px-3 py-1.5 rounded-lg transition-all active:scale-95 flex items-center gap-1 cursor-pointer shadow-sm hover:bg-white/95 shrink-0 ml-2"
            >
              <span>View Cart</span>
